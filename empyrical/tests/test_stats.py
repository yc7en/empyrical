...
class TestStats(TestCase):
    ...
    @parameterized.expand([
        ...
        ([mixed_returns, negative_returns], 0, [[0.0, 0.01, 0.111, 0.066559,
        0.08789, 0.12052, 0.14293, 0.15436, 0.03893], [0.0, -0.06, -0.1258,
        -0.13454, -0.21243, -0.22818, -0.27449, -0.33253, -0.36590]])
    ])
